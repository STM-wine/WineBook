...
from components.supplier_catalog.supplier_logistics import render_supplier_logistics
...
def render_supplier_catalog(importers_data, repo=None, source_label: str = "importers.csv") -> None:
    ...
    tab_search, tab_add, tab_requests, tab_logistics, tab_pending, tab_prices = st.tabs(
        [
            "Search Wines",
            "Add Wine",
            "Requests",
    ...
    with tab_logistics:
        render_supplier_logistics(repo, importers_data, source_label)
    with tab_pending:
