...
type HubArea = "search" | "add" | "requests" | "pending" | "price-changes" | "vendors" | "logistics";
...
export function SupplierHubView({
  ...
  onSaveVendorMappings: (mappings: QuickBooksVendorMapping[]) => void;
  ...
  return (
    <section className="panel supplier-hub-panel" id="supplier-hub">
      ...
      {activeArea === "vendors" ? (
        <QuickBooksVendorsPanel
          vendors={quickBooksVendors}
          mappings={quickBooksVendorMappings}
          suppliers={suppliers}
          isPending={isPending}
          onSaveVendorMappings={onSaveVendorMappings}
        />
      ) : null}
...
function QuickBooksVendorsPanel({
  vendors,
  mappings,
  suppliers,
  isPending,
  ...
  function saveChanges() {
    ...
    onSaveVendorMappings(changedMappings);
  }
    ...
    <div className="supplier-hub-workspace">
      <div className="section-heading compact-heading">
        <div>
          ...
          <p>Classify QB vendors and match inventory suppliers to Stem logistics rows.</p>
        </div>
        <button
