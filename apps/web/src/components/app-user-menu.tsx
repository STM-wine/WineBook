...
export function AppUserMenu({ canViewSettings, isSettingsActive }: AppUserMenuProps) {
  ...
  return (
    <div className="app-user-menu" ref={menuRef}>
      <button
        className={isSettingsActive ? "app-user-menu-trigger active" : "app-user-menu-trigger"}
      ...
      {isOpen ? (
        <div className="app-user-menu-panel" role="menu">
          {canViewSettings ? (
            <Link className="app-user-menu-item" href="/settings" role="menuitem">
              Settings
            </Link>
          ) : null}
          <button
          ...
          <button className="app-user-menu-item app-user-menu-danger" onClick={signOut} type="button" role="menuitem">
            Sign Out
          </button>
        </div>
      ) : null}
