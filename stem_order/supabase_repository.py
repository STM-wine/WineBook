...
class SupabaseRepository:
    ...
    def _recommendation_payload(self, report_run_id: str, row: dict[str, Any]) -> dict[str, Any]:
        return {
            ...
            "inventory_value": clean_value(row.get("inventory_value"), 0),
            "days_since_last_sale": clean_value(row.get("days_since_last_sale")),
            "inventory_risk_label": clean_value(row.get("inventory_risk_label")),
            "inventory_risk_reason": clean_value(row.get("inventory_risk_reason")),
            ...
            "diagnostics": {
                ...
                "fob": clean_value(row.get("fob")),
                "inventory_value": clean_value(row.get("inventory_value")),
                "days_since_last_sale": clean_value(row.get("days_since_last_sale")),
                "inventory_risk_label": clean_value(row.get("inventory_risk_label")),
